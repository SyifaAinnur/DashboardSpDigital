...
export default defineComponent({
    ...
    methods: {
        ...
        handleClickOutside(event: Event) {
            ...
            // Memeriksa apakah elemen yang diklik bukanlah bagian dari sidebar atau tombol untuk membukanya
...
<template>
    <div class="font-base bg-[#101828]">
        ...
        <aside ref="sidebar" id="logo-sidebar" :class="sidebarClasses" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-[#101828] dark:bg-gray-800">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="#"
                            class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-black hover:text-black dark:hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white"
        ...
        <div class="ps-6 pt-5 sm:ml-64">
            <div class="p-4 dark:border-gray-700 bg-white rounded-tl-3xl">
